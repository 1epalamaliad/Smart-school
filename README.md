...
<ol>
  ...
  <li>Οι πόρτες να ανοίγοκλείνουν μόνες τους όταν φτάσει κάποιος κοντά.
  <li>Ο φωτισμός, το ρεύμα ,οι πρίζες καθώς και οι υπολογιστές της τάξεως να ανάβουν τη στιγμή που κάποιος περάσει για πρώτη φορά από την πόρτα.
